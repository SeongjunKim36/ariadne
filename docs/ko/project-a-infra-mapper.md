...
> 상태: Phase 5 진행 중 (릴리즈 레디니스 + 공개 문서 + 성능 하드닝 + 데모 자산 완료, 외부 포트폴리오 리포 반영만 남음) · 최초 작성: 2026-04-10 · **타당성 검증 완료: 2026-04-13** · 관련 문서: [Theseus - 코드 토폴로지 맵퍼](./project-b-code-mapper.md)
...
- **백엔드**: Spring Boot 3.x + Java 17 (현재 구현 기준 확정 — Spring Data Neo4j 생산성, Gradle/Testcontainers 호환성, 공개 저장소 재현성)
...
- [x] 백엔드 언어: **Spring Boot 3.x + Java 17** (2026-04-13 확정 — 현재 구현/CI/로컬 실행 기준)
- [x] 경쟁 분석: **Cartography 대비 차별점** 명시 (2026-04-13 추가)
- [x] 일정: **5-6개월**로 현실적 조정 (2026-04-13 — 기능 유지, 기간 확장)
- [x] 저장소 호스팅 (GitHub public) — `SeongjunKim36/ariadne` (2026-04-16)
- [ ] Phase 0 실제 시작일
- [ ] 혼자 할지 vs 동료 끌어들일지
