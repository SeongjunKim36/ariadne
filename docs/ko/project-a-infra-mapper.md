...
> 상태: Phase 2 진행 중 (SG rule graph + CidrSource 시각화 + ECS/Lambda/EC2 연결 IAM role 수집 + nginx raw config 파싱 완료, 상세 수집/보안 하드닝 진행 중) · 최초 작성: 2026-04-10 · **타당성 검증 완료: 2026-04-13** · 관련 문서: [Theseus - 코드 토폴로지 맵퍼](./project-b-code-mapper.md)
